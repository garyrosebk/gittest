package spring.cloud.communication.account.controller;
...
public class AccountController {
	...
	@PostMapping
	public Account add(@PathVariable Account account) {
		return repository.add(account);
	}
	
	@PutMapping
	public Account update(@PathVariable Account account) {
